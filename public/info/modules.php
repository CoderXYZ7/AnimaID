<?php
$pageTitle = 'AnimaID - Modules';
$markdownFile = '../../../docs/TechStack.md';
$content = file_exists($markdownFile) ? file_get_contents($markdownFile) : 'Modules documentation not found.';
?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <nav class="hidden md:flex space-x-8">
                    ...
                    <a href="modules.php" class="text-blue-600 font-medium">Modules</a>

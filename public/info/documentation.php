<?php
$pageTitle = 'AnimaID - Documentation';
$markdownFile = '../../../docs/UserManual.md';
$content = file_exists($markdownFile) ? file_get_contents($markdownFile) : 'Documentation documentation not found.';
?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <nav class="hidden md:flex space-x-8">
                    ...
                    <a href="documentation.php" class="text-blue-600 font-medium">Documentation</a>
                    <a href="documentation.php" class="text-gray-600 hover:text-blue-600 transition-colors">Documentation</a>
                    <a href="documentation.php" class="text-gray-600 hover:text-blue-600 transition-colors">Applets</a>
                    <a href="documentation.php" class="text-gray-600 hover:text-blue-600 transition-colors">API</a>
                    <a href="documentation.php" class="text-gray-600 hover:text-blue-600 transition-colors">Documentation</a>
                </nav>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li><a href="documentation.php" class="hover:text-white transition-colors">Documentation</a></li>
                        <li><a href="documentation.php" class="hover:text-white transition-colors">Applets</a></li>
                        <li><a href="documentation.php" class="hover:text-white transition-colors">API</a></li>
                    </ul>
                </div>
